...
const SOURCES: (typeof schema.sources.$inferInsert)[] = [
  ...
  { id: "hospitalitynet", name: "HospitalityNet", url: "https://www.hospitalitynet.org/rss/news.xml", sourceType: "trade_press", ingestionMethod: "rss", language: "en", cadence: "daily", licenceNote: "RSS + API; FP-filtered; republished PRs. review_required if public." },
  { id: "hospitalitynet-openings", name: "HospitalityNet (hotel openings)", url: "https://www.hospitalitynet.org/rss/announcements/openings.xml", sourceType: "trade_press", ingestionMethod: "rss", language: "en", cadence: "daily", licenceNote: "Hotel openings feed; FP-filtered. review_required if public." },
  { id: "travelpulse", name: "TravelPulse", url: "https://www.travelpulse.com", sourceType: "trade_press", ingestionMethod: "manual", language: "en", cadence: "daily", active: false, licenceNote: "Site-wide 403 (bot-protected), no native RSS. Cruise beat served via CruiseMapper rollup + cruise-line press (JS-rendered) + local news." },
  ...
  { id: "cruiseindustrynews", name: "Cruise Industry News", url: "https://cruiseindustrynews.com", sourceType: "trade_press", ingestionMethod: "rss", language: "en", cadence: "daily", licenceNote: "WordPress RSS; FP-filtered. Cruise deployment and itinerary news." },
  { id: "traveldailynews-asia", name: "TravelDailyNews Asia & Pacific", url: "https://www.traveldailynews.asia", sourceType: "trade_press", ingestionMethod: "rss", language: "en", cadence: "daily", licenceNote: "WordPress RSS; FP-filtered. B2B Asia-Pacific travel/hospitality trade press." },
  { id: "fm27", name: "Fāri'ira'a Manihini 2027 (FM27)", url: "https://fm27.pf/en/", sourceType: "tourism", ingestionMethod: "rss", language: "en", cadence: "monthly", licenceNote: "WordPress RSS at /en/feed/. Sustainable-tourism strategy + updates." },
  { id: "air-tahiti-nui-corp", name: "Air Tahiti Nui (corporate)", url: "https://us.airtahitinui.com/news", sourceType: "airline", ingestionMethod: "crawl", language: "en", cadence: "weekly", licenceNote: "Intl routes/capacity/codeshare news (/news/corporate). HTML crawl." },
  { id: "air-tahiti-corp", name: "Air Tahiti", url: "https://www.airtahiti.com/actualites", sourceType: "airline", ingestionMethod: "crawl", language: "fr", cadence: "weekly", active: false, licenceNote: "/actualites returns 403 (bot-block); route news flows via local feeds." },
  { id: "air-moana", name: "Air Moana", url: "https://www.airmoana.com", sourceType: "airline", ingestionMethod: "crawl", language: "fr", cadence: "weekly", active: false, licenceNote: "No static news page; route news flows via local feeds." },
